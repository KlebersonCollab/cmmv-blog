                    ...
                    <div class="flex-grow">
                        ...
                        />
                                    ...
                                    <header class="post-header my-6">
                                        <div class="post-meta flex items-center">
                                            ...
                                            <div class="post-status ml-4" v-if="post.status !== 'published'">
                                                <span class="bg-[#ed1c24] text-white px-2 py-1 rounded-full text-xs font-semibold">{{ post.status?.toUpperCase() }}</span>
                                            </div>
                                        </div>
                                    </header>
                                    ...
                                    class="w-full h-full object-cover imgix-lazy" width="44" height="44" icon-size="sm" />
                                                <div v-else
                                                    class="w-full h-full flex items-center justify-center bg-[#ed1c24] text-white font-bold text-lg">
                                                    {{ authorInitials }}
                                                </div>
                                            </div>
                                    ...
                                    <div class="mt-10">
                                        ...
                                        <div ref="relatedPostsObserver" class="min-h-[200px]">
                                            ...
                                            />
                                                    ...
                                                    <div class="p-4">
                                                        <a :href="`/post/${relatedPost.slug}`" class="block">
                                                            <h3 class="text-lg font-bold text-gray-800 mb-2 hover:text-[#ed1c24] transition-colors line-clamp-2">
                                                                {{ relatedPost.title }}
                                                            </h3>
                                                        </a>
                            ...
                            <div class="lg:col-span-1 min-w-[300px]">
                                ...
                                <!-- Categories Widget -->
                                <CategoryWidget v-if="categories && categories.length > 0" :categories="categories" />
